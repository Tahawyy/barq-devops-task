...
- Starting video commit: 90e3d7c
- Later documentation-only commits, if any: 6f6d6d3 (CI alignment), 166a15f (README/docs alignment)

The final system state is three app instances behind NGINX on port 8090.
The repository's default and the video's demonstrated state both use port 8090,
so CI, docs, diagram, and video all match.